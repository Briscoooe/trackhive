  ...
  return (
    <div className={'flex flex-col items-center space-y-2'}>
      {[SPOTIFY_PLAYLIST_RELEASE_RADAR_NAME, SPOTIFY_PLAYLIST_DISCOVER_WEEKLY_NAME, SPOTIFY_PLAYLIST_TODAYS_TOP_HITS_NAME, SPOTIFY_PLAYLIST_RAP_CAVIAR_NAME]
        .map((playlistName:string) => (<Badge key={playlistName} className={'cursor-pointer w-full text-sm whitespace-nowrap flex justify-between'} onClick={() => setSearchText(playlistName)}>
